...
import de.sir4gt10.dragsortlistview.DragSortController;
import de.sir4gt10.dragsortlistview.DragSortListView;
...
import de.sir4gt10.mpdcontrol.models.AbstractPlaylistMusic;
import de.sir4gt10.mpdcontrol.models.ListFragment;
import de.sir4gt10.mpdcontrol.models.PlaylistSong;
import de.sir4gt10.mpdcontrol.models.PlaylistStream;
import de.sir4gt10.mpdcontrol.mpd.AlbumInfo;
import de.sir4gt10.mpdcontrol.mpd.MPD;
import de.sir4gt10.mpdcontrol.mpd.MPDPlaylist;
...
import de.sir4gt10.mpdcontrol.tools.Tools;
import de.sir4gt10.mpdcontrol.view.holders.PlayQueueViewHolder;
...
public class PlaylistFragment extends ListFragment  implements StatusChangeListener
{
	...
	private class QueueAdapter extends ArrayAdapter 
	{
        ...
        public View getView(int position, View convertView, ViewGroup parent) 
        {
            ...
            if (music.isForceCoverRefresh() || viewHolder.cover.getTag() == null || !viewHolder.cover.getTag().equals(music.getAlbumInfo().getKey())) 
            {
                ...
                {
                    viewHolder.cover.setImageResource(R.drawable.ic_headset_white_48dp);
                }
    ...
    protected void update(boolean forcePlayingIDRefresh) 
    {
        try 
        {
            ...
            for (Music m : new ArrayList<Music>(musics)) 
            {
                ...
                {
                    item.setCurrentSongIconRefID(R.drawable.ic_play_arrow_white_48dp);
    ...
    public void trackChanged(MPDStatus mpdStatus, int oldTrack) 
    {
        if (songlist != null) 
        {
            ...
            {
                int newPlay;
                if ((song.getSongId()) == mpdStatus.getSongId()) newPlay = R.drawable.ic_play_arrow_white_48dp;
                else newPlay = 0;
